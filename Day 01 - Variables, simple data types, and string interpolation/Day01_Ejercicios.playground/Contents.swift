...
let mensaje_nacimiento: String = "Yo nací en \(lugar_de_nacimiento)"
...
var mensaje_interpolacion: String = "Hola mi nombre es \(nombre) y tengo \(edad_actual) años"
...
let variable_double1: Double = 11.5
let variable_double2: Double = 22.5
let multiplicacion_double: Double = variable_double1 * variable_double2
...
var mensaje: String = "Mido \(altura_metros) metros."
...
let precio_final: String = "El precio final es S/\(precio_sin_impuesto+(precio_sin_impuesto * impuesto)) "
